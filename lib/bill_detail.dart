import 'package:easy_receipt/bill_image.dart';
        ...
        children: [
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  _value(
                      ReceiptPreviewScreen.selectedBill.accountNo.toString()),
                  _sizedBox(),
                  _title("Customer Key"),
                  ...
                  _title("Current Read"),
                  _value(
                      ReceiptPreviewScreen.selectedBill.currentRead.toString()),
                  _sizedBox(),
                  _title("Previous Read"),
                  _value(ReceiptPreviewScreen.selectedBill.previousRead
                      .toString()),
                  _sizedBox(),
                  _title("Amount"),
                  _value(ReceiptPreviewScreen.selectedBill.previousRead
                  ...
                  _title("Consumption"),
                  _value(
                      ReceiptPreviewScreen.selectedBill.consumption.toString()),
                  _sizedBox(),
          ...
          RaisedButton(
              ...
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => BillImage()),
                );
              },
